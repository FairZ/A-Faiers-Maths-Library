...
int AllegroInit()			//this function is run to initialize allegro and its components for later use
{
	...
	else						//if allegro has initilized continue to set up allegro
	{
		...
		graphicsMode = set_gfx_mode(GFX_AUTODETECT_WINDOWED, 700, 700, 0, 0);		//set the values of graphics mode and sound check according to if either initilizations worked
